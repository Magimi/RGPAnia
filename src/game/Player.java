...
public class Player {
    ...
    public static void Stats() {
        ...
        System.out.println(PURPLE+"(1)Rozdaj punkty umiejętności/(x)wróć"+RESET);
    ...
    public static void Eq() {
        ...
        int j=0;
        for(int x = 0; x < Eq.ItemEq.length; x++){
            if(Eq.ItemEq[x] != -1){
                j++;
            }
        }
        System.out.println("Plecak 1: "+j+"/10");
        for (int x = 0; x<5; x++){
            if (Eq.WeaponEq[x] != -1) {
        ...
        int i=0;
        for(int x = 0; x < Eq.WeaponEq.length; x++) {
            if (Eq.WeaponEq[x] != -1) {
                i++;
            }
        }
        System.out.println("Plecak 2: "+i+"/5");
    ...
    public static boolean block(){
        double random = Random.random(0,100);
        if(random<=deffence){
            System.out.println("Blokujesz atak");
            return true;
        }
        else return false;
